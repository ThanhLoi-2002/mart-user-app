...
class DashboardScreenState extends State<DashboardScreen> {
                  ...
                  ResponsiveHelper.isDesktop(context) || keyboardVisible
                      ...
                      : Align(
                          ...
                          child: GetBuilder<SplashController>(builder: (splashController) {
                            ...
                            bool isTaxiWithCache = ((splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.taxi) ||
                                    (splashController.cacheModule != null && splashController.cacheModule!.moduleType.toString() == AppConstants.taxi)) &&
  ...
  Widget trackView(BuildContext context, {required bool status}) {
    return Container(
        height: 3,
        decoration:
            BoxDecoration(color: status ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withValues(alpha: 0.5), borderRadius: BorderRadius.circular(Dimensions.radiusDefault)));
  }
}
